...
import com.example.bibliotecaduocv2.services.LibroService;
...
public class LibroController {
    ...
    public int getMethodName(@PathVariable int anio) {
        return libroService.librosPorAnio(anio);
    }

    @GetMapping("/buscar/autor/{autor}")
    public List<Libro> buscarPorAutores(@PathVariable String autor) {
        return libroService.libroPorAutor(autor);
    }
